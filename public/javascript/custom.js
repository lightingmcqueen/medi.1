...
$('#detail-tab li a').on('click', function(e) {
    e.preventDefault();
    if ($(window).width() < 767 ) {
    $('#navigation').toggle(200);
        
    }   
$('#detail-tab li a[href^="/' + location.pathname.split("/")[1] + '"]').addClass('active');
...
//         $('#detail-tab').addClass('fixed-pos');
//     }
//     else {
//         $('#detail-tab').removeClass('fixed-pos');   
//     }  
// });  
